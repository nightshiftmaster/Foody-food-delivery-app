  ...
  return (
    ...
    >
      <div className="md:h-[90vh]  gap-5 md:text-base text-sm h-full bg-white shadow-xl rounded-xl  text-center flex items-center justify-center flex-col xl:w-[80vh] w-full ">
        <div>
          <h1 className="text-gray-700 font-thin md:text-4xl text-2xl uppercase">
            Contact Us
          </h1>
        </div>
        ...
        >
          ...
          <button
            disabled={disable}
            type="submit"
            className="text-white uppercase whitespace-nowrap p-3 text-xs lg:p-3 lg:px-10 text-center lg:text-base rounded-md bg-red-500 hover:scale-110 transition-all duration-500"
          >
            Send Message
          </button>
        </form>
